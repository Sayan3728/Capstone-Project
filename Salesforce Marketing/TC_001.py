...
def test_verify_available_views(driverfix):
    # Logging in section
    ...
    driverfix.find_element(By.ID, "tsid").click()
    time.sleep(10)
    driverfix.find_element(By.LINK_TEXT, "Marketing").click()
    time.sleep(10)
    driverfix.find_element(By.LINK_TEXT, "Campaigns").click()
    time.sleep(10)
    #clicking on view
    driverfix.find_element(By.ID, "fcf").click()
    time.sleep(10)
    # logging out section
